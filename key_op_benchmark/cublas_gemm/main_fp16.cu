/**
 * cuBLAS FP16 GEMM benchmark
 * Usage: ./gemm_fp16 [gpu_id] [M] [K] [N] [iters] [warmup]
 */
#include "common.h"
...
int main(int argc, char** argv) {
    ...
    size_t size_A = (size_t)cfg.M * cfg.K * sizeof(__half);
    size_t size_B = (size_t)cfg.K * cfg.N * sizeof(__half);
    size_t size_C = (size_t)cfg.M * cfg.N * sizeof(__half);
    ...
    for (int i = 0; i < cfg.warmup; i++)
        run_gemm_fp16(handle, cfg.M, cfg.N, cfg.K, d_A, d_B, d_C);
